        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    myCommand.Connection = co;
                    myAdapter.SelectCommand = myCommand;
                    myCommand.CommandText = "UPDATE Table_Barang SET NamaBarang='" + textBox2.Text + "', HargaJual='" + textBox3.Text + "', HargaBeli='" + textBox4.Text + "', JumlahBarang='" + textBox5.Text + "', SatuanBarang='" + textBox6.Text + "' WHERE KodeBarang='" + textBox1.Text + "'";
                    DataSet ds = new DataSet();
